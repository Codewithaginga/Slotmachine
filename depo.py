...
def get_number_of_lines():
    while True:
        ...
        if lines.isdigit():
            ...
            lines = int(lines)
            if 1 <= lines <= MAX_LINES: #  1 is the minimal input number
                break
...
def get_bet():
    ...
    while True:
        amount = input("What much would you like to stake  to each line? $")
        if amount.isdigit():
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            ...
            print(
                f'you have insufficient balance, your balance is ${balance}'
            )
        
        else:
            break
    print(f'Your bet amount is ${bet} on {line} lines. Total bet is equal to: ${total_bet}')
